...
public class RtpPacket {
	...
	public String toString() {
		return String.format("PT=%d, SSRC=0x%08x, Seq=%4d, len=%4d, plen=%4d, ts=%d %s", getPayloadType(), getSscr(), getSequenceNumber(), getLength(), getPayloadLength(), getTimestamp(), hasMarker() ? "Mark" : "");
	}
